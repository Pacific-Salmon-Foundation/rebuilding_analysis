---
title: 'Appendix A: Chinook Rebuilding Systems'
output:
...
```{r pni overall plot,echo=FALSE,message=FALSE,warning=FALSE,fig.height=8,fig.width=7,fig.cap="pHOS in Chinook rebuilding systems."}
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.height=8,fig.width=7,fig.cap="pHOS in Chinook rebuilding systems."}
